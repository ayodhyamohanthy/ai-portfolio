...
<nav className="atlas-nav"><Link href="/" className="wordmark">Ayodhya Mohanthy</Link><Link href="/system">System</Link><div><Link href="/components">Components</Link><Link href="/sources">Sources</Link><Link href="/atlas">Atlas</Link><Link href="/tools">Tools</Link><Link href="/benchmarks">Benchmarks</Link><Link href="/thinking">Thinking</Link></div></nav>
<header className="atlas-hero"><p className="eyebrow">FRESH · AI-NATIVE DESIGN</p><h1>New, and checked.<br/><i>Landed when the field moves.</i></h1><p>Sources, products and methods in AI-native design, watched hourly and landed only when they verify. No timer promises. Spot something first: <a href="mailto:ayodhyarammohanthy@gmail.com">ayodhyarammohanthy@gmail.com</a>.</p></header><SystemTrail current="Stay current"/>
