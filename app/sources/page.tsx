...
<nav className="atlas-nav"><Link href="/" className="wordmark">Ayodhya Mohanthy</Link><div><Link href="/components">Components</Link><Link href="/atlas">Atlas</Link><Link href="/fresh">Fresh</Link><Link href="/tools">Tools</Link><Link href="/benchmarks">Benchmarks</Link><Link href="/thinking">Thinking</Link></div></nav>
...
<div className="sources-anchors"><Link href="/resources">74 live patterns ↗</Link><Link href="/atlas">The atlas ↗</Link></div></section>
