...
<nav className="atlas-nav"><Link href="/" className="wordmark">Ayodhya Mohanthy</Link><div><Link href="/resources">Components</Link><Link href="/atlas">Atlas</Link><Link href="/library">Starter kit</Link></div></nav>
...
{t.items.map((s,i)=><article className="source-item" key={s.url}><span className="num">{ti+1}.{i+1}</span><div>
...
<footer className="resource-footer"><Link href="/">Ayodhya Mohanthy</Link><span>{total} readings · curated by Ayodhya · reviewed 10 Sep 2026</span><Link href="/resources">Components ↗</Link><Link href="/atlas">Atlas ↗</Link><Link href="/accessibility">Accessibility ↗</Link></footer>
</main>}
