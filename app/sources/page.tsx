...
<nav className="atlas-nav"><Link href="/" className="wordmark">Ayodhya Mohanthy</Link><Link href="/system">System</Link><div><Link href="/components">Components</Link><Link href="/atlas">Atlas</Link><Link href="/fresh">Fresh</Link><Link href="/tools">Tools</Link><Link href="/benchmarks">Benchmarks</Link><Link href="/thinking">Thinking</Link></div></nav>
<header className="atlas-hero"><p className="eyebrow">SOURCES · AI-NATIVE DESIGN</p><h1>Read the field.<br/><i>In the order I would.</i></h1><p>Canonical readings for AI-native design, sequenced as a path. Every note is mine, written after reading the piece. Suggest what is missing: <a href="mailto:ayodhyarammohanthy@gmail.com">ayodhyarammohanthy@gmail.com</a>.</p></header><SystemTrail current="Learn"/>
